...
<div class="container">
  <div class="row">
    <div class="col-md-6">
      <h2 class="tv-title-404-tm">Cette page <?php echo $var; ?></h2>
      <a href="http://<?= $_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])?>">
        <button class="btn btn-primary">Revenir a l'accueil</button>
      </a>
    </div>
    <div class="col-md-6">
